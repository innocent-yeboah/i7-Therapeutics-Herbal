...
export const HEALING_SERVICES: HealingService[] = [
  {
    ...
    image: "/services/hand-and-foot-massage.png",
    durationMinutes: 45,
    priceGhs: 120,
    bookable: true,
  ...
  },
  {
    ...
    icon: "massage",
    category: SERVICE_CATEGORY,
    image: "/services/head-neck-shoulder-massage.png",
    durationMinutes: 45,
    priceGhs: 130,
    bookable: true,
  ...
  },
  {
    ...
    icon: "massage",
    category: SERVICE_CATEGORY,
    image: "/services/spine-and-back-massage.jpg",
    durationMinutes: 60,
    priceGhs: 180,
    bookable: true,
  ...
  },
  {
    ...
    icon: "cupping",
    category: SERVICE_CATEGORY,
    image: "/services/cupping-therapy.png",
    durationMinutes: 60,
    priceGhs: 200,
    bookable: true,
  ...
  },
  {
    ...
    icon: "sports-injury",
    category: SERVICE_CATEGORY,
    image: "/services/sports-injury-management.jpg",
    durationMinutes: 60,
    priceGhs: 220,
    bookable: true,
  ...
  },
  {
    ...
    category: SERVICE_CATEGORY,
    image: "/services/stroke-recovery-management.png",
    durationMinutes: 60,
    priceGhs: 200,
    bookable: true,
  ...
  },
  {
    ...
    icon: "lymphatic",
    category: SERVICE_CATEGORY,
    image: "/services/lymphatic-drainage-massage.png",
    durationMinutes: 60,
    priceGhs: 190,
    bookable: true,
  ...
  },
  {
    ...
    icon: "meridian",
    category: SERVICE_CATEGORY,
    image: "/services/meridian-massage.png",
    durationMinutes: 75,
    priceGhs: 210,
    bookable: true,
  ...
  },
  {
    ...
    icon: "nmt",
    category: SERVICE_CATEGORY,
    image: "/services/advanced-deep-tissue-nmt.png",
    durationMinutes: 75,
    priceGhs: 240,
    bookable: true,
  ...
  },
  {
    ...
    icon: "herbal-oil",
    category: SERVICE_CATEGORY,
    image: "/services/herbal-oil-relaxation-massage.png",
    durationMinutes: 60,
    priceGhs: 170,
    bookable: true,
...
export const COMING_SOON_OFFERINGS: ComingSoonOffering[] = [
  ...
  },
  {
    ...
    icon: "meditation",
    image: "/shop/meditation-practice.png",
  },
  {
    slug: "self-healing",
    name: "Self Healing",
